...
Gosto muito de tecnologia, sempre buscando me atualizar todos os dias com notícias, fóruns, etc. Me sinto mais à vontade em Programação Front-end e Programação de Dispositivos Móveis, no qual é a área que desejo trabalhar profissionalmente.
## Minhas estatistícas 📊📈
...
2. Programação Web Front End 📏
3. Programação de Dispositivos Móveis 📱
